...
Add the id num - to join the sequence of Numbers for id integer num 
Merge id1 id2 - merger sequence number of id1 and id2, and make id2 empty 
The unique id - remove repetitive element in the sequence id 
Out id - from small to large, output the elements of sequence of Numbers for ids separated by Spaces 

the First Line is n which mean the number of the Command(n <= 200000).The next n lines are correct Command.
Then output according the require.
